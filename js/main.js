...
const i18n = {
  pt: {
    ...
    cd_p3_problem: "Consolidação de 9+ fontes de dados era feita manualmente — horas de trabalho operacional por regional, por dia.",
    ...
    exp1_desc:   "Atuo na conta AudioNova — operação de saúde auditiva com 280+ lojas e múltiplas regionais. Sou responsável pelo desenvolvimento da infraestrutura analítica que sustenta as decisões operacionais: pipelines de dados, dashboards, automações e integrações entre sistemas. A gestão de campanhas em plataformas de mídia é parte do contexto, não o centro da atuação.",
    exp1_b1:     "Desenvolvimento e manutenção de pipeline de dados conectando 9 APIs — coleta, normalização e consolidação automática por regional",
    exp1_b2:     "Dashboard web interno para análise de performance por loja, regional e canal — com autenticação, filtros e exportação de dados de 280+ unidades",
    exp1_b3:     "Relatório diário automatizado: redução de até 90% em trabalho manual de consolidação, dados disponíveis toda manhã antes do horário de trabalho",
    exp1_b4:     "Integração server-side de eventos de conversão (Meta CAPI, TikTok CAPI), auditoria de divergências entre plataforma e CRM, e apresentação de resultados diretamente ao cliente",
    ...
    exp2_b1:     "Análise de dados de aquisição e funil em múltiplos países; dashboards executivos em Looker Studio, Power BI e Excel para equipes de marketing, produto e gestão",
    ...
    p1_title: "Automação de Relatórios Multi-Fonte",
    p1_desc:  "Pipeline que automatiza a consolidação diária de dados de 9+ fontes em um único relatório estruturado por regional — eliminando horas de trabalho manual e garantindo dados consistentes para tomada de decisão.",
    ...
    p7_title: "Análise Granular Multi-Fonte",
    p7_desc:  "Dashboard interno que integra dados de múltiplas fontes externas com registros internos — análise granular por item com drill-down, filtros cruzados e exportação Excel.",
    ...
    about_p1:    "Sou um profissional de dados com base em tecnologia e experiência prática em operações de BI, CRM e automação. Comecei atuando em marketing digital e percebi que as melhores decisões de negócio não vinham de estratégia — vinham da qualidade dos dados disponíveis.",
    about_p2:    "Gosto de trabalhar onde existe problema real de operação: dado quebrado, relatório manual, processo sem integração ou decisão tomada no escuro. Meu foco é transformar isso em pipeline, automação e clareza.",
    about_p3:    "Hoje meu foco está em BI, automação e integração de dados — construindo soluções que conectam fontes dispersas e transformam dados operacionais em decisões mais rápidas, confiáveis e acionáveis.",
  ...
  en: {
    ...
    cd_p3_problem: "Consolidating 9+ data sources was done manually — hours of operational work per region, per day.",
    ...
    exp1_desc:   "Working on the AudioNova account — a hearing health operation with 280+ stores across multiple regions. I'm responsible for building the analytics infrastructure behind operational decisions: data pipelines, dashboards, automations, and system integrations. Campaign management on media platforms is part of the context, not the center of the work.",
    exp1_b1:     "Development and maintenance of a data pipeline connecting 9 APIs — automatic collection, normalization, and consolidation by region",
    exp1_b2:     "Internal web dashboard for performance analysis by store, region, and channel — with authentication, filters, and data export for 280+ units",
    exp1_b3:     "Automated daily report: up to 90% reduction in manual consolidation work, data available every morning before work hours",
    exp1_b4:     "Server-side event integration (Meta CAPI, TikTok CAPI), CRM-vs-platform divergence audits, and direct client reporting",
    ...
    p1_title: "Multi-Source Report Automation",
    p1_desc:  "Pipeline that automates daily consolidation of data from 9+ sources into a single structured report by region — eliminating hours of manual work and ensuring consistent data for decision-making.",
    ...
    p7_title: "Multi-Source Granular Analytics",
    p7_desc:  "Internal dashboard integrating data from multiple external sources with internal records — granular analysis per item with drill-down, cross-filters, and Excel export.",
    p8_title:  "Store-Level Analytics",
    ...
    about_p1:    "I'm a data professional with a technology background and hands-on experience in BI, CRM, and automation operations. I started in digital marketing and realized that the best business decisions don't come from strategy — they come from data quality.",
    about_p2:    "I like working where there's a real operational problem: broken data, manual reporting, unintegrated processes, or decisions made in the dark. My focus is turning that into pipelines, automation, and clarity.",
    about_p3:    "Today my focus is on BI, automation, and data integration — building solutions that connect scattered sources and turn operational data into faster, more reliable, and more actionable decisions.",
...
const projects = {
  "media-reports": {
    pt: {
      ...
      title: "Automação de Relatórios Multi-Fonte",
      ...
      context: {
        label: "Contexto",
        text: "Operação em 9+ plataformas e sistemas, cada um com API própria, estrutura de dados diferente e autenticação distinta. A consolidação por regional era feita manualmente, com alto risco de erro e custo de horas semanais."
      },
      responsibility: {
...
def normalize_by_regional(rows):
    ...
    en: {
      ...
      title: "Multi-Source Report Automation",
      stack: ["Python", "GitHub Actions", "Google Sheets API", "Meta Marketing API", "Google Ads API (GAQL)", "TikTok Ads API", "Taboola API", "Bing Ads API", "X Ads API", "Pinterest API", "MySQL", "FastAPI"],
      problem: {
        label: "The Problem",
      ...
      context: {
        label: "Context",
        text: "Operation across 9+ platforms and systems, each with its own API, data structure, and authentication. Regional consolidation was done manually, with high error risk and a weekly cost of several hours."
      },
      responsibility: {
...
def normalize_by_regional(rows):
  ...
  "leads-processor": {
    pt: {
      ...
      title: "Pipeline de Tratamento de Dados",
...
def send_capi_event(lead_data, event_name="Lead"):
  ...
  "email-clickup": {
    pt: {
      ...
      title: "Automação de Workflow Operacional",
...
def send_tiktok_event(lead_data, event_name="SubmitForm"):
  ...
  "ad-analytics": {
    ...
    pt: {
      ...
      title: "Análise Granular Multi-Fonte",
