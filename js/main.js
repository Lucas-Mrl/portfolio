...
const i18n = {
  pt: {
    ...
    sc1_ctx:   "Para construir queries, modelos analíticos e dashboards que equipes de negócio consigam usar para tomar decisões.",
  ...
  en: {
    ...
    sc1_ctx:   "To build queries, analytical models, and dashboards that business teams can actually use to make decisions.",
