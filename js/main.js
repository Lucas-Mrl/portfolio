...
const i18n = {
  pt: {
    ...
    cap1_ex:    "Ex: Dashboard de 280+ lojas com drill-down por regional, canal e período — cruzando dados de plataforma com CRM.",
    cap2_title: "Data Pipelines & Automação",
    cap2_desc:  "Pipelines de coleta, normalização e consolidação de dados com Python — conectando APIs, CRMs, bancos e planilhas. ETL/ELT que elimina trabalho manual recorrente e garante dados disponíveis no início de cada ciclo operacional.",
    cap2_ex:    "Ex: Pipeline que conecta 9 plataformas de mídia e entrega relatório consolidado por regional às 3h da manhã.",
    cap3_title: "Marketing Analytics & Tracking",
    cap3_desc:  "Análise de aquisição, funil de conversão e performance de mídia com GA4, GTM e integração server-side (Meta CAPI, TikTok Events API). Conhecimento de mídia paga como diferencial — entendo o significado dos dados, não apenas a infraestrutura.",
    cap3_ex:    "Ex: Meta CAPI + TikTok CAPI server-side, auditoria de divergências entre plataforma e CRM, análise de CPA real por anúncio.",
    ...
    exp3_role:   "Analista de Performance e Funis",
    ...
    exp4_role:    "Marketing Digital & Performance",
    ...
    p1_title: "Pipeline de Automação Multi-Fonte",
  ...
  en: {
    ...
    cap1_ex:    "Ex: Dashboard for 280+ stores with drill-down by region, channel and period — crossing platform data with CRM.",
    cap2_title: "Data Pipelines & Automation",
    cap2_desc:  "Data collection, normalization and consolidation pipelines in Python — connecting APIs, CRMs, databases and spreadsheets. ETL/ELT that eliminates recurring manual work and ensures data availability at the start of each operational cycle.",
    cap2_ex:    "Ex: Pipeline connecting 9 media platforms delivering a consolidated regional report at 3am.",
    cap3_title: "Marketing Analytics & Tracking",
    cap3_desc:  "Acquisition analysis, conversion funnels, and media performance with GA4, GTM, and server-side integration (Meta CAPI, TikTok Events API). Marketing background as a differentiator — I understand what the data means, not just the infrastructure behind it.",
    cap3_ex:    "Ex: Meta CAPI + TikTok CAPI server-side, CRM divergence audits, real CPA analysis by individual ad.",
    ...
    exp3_role:   "Performance Analyst & Funnel Specialist",
    exp3_loc:    "Senden Mídias · Delivery · 13 simultaneous accounts",
    ...
    p1_title: "Multi-Source Data Pipeline",
